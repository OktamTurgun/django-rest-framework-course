...
Bu fayl production muhit uchun Django settings konfiguratsiyasini ko'rsatadi.
...
# Example: ALLOWED_HOSTS=yourdomain.com,www.yourdomain.com,123.45.67.89
...
# Proxy configuration (if behind a proxy like Nginx)
...
ADMINS = [
    ('Admin Name', config('ADMIN_EMAIL', default='admin@library.com')),
]
